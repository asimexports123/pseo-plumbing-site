    ...
    <div className="border-t border-gray-200 pt-4 mt-8">
      <div className="grid md:grid-cols-3 gap-4 text-xs text-gray-600">
        <div>
          ...
          <p className="mt-2">
            <Link href="/about" className="text-blue-700 hover:underline no-underline inline-block py-1">About YoHomeFix</Link>
          </p>
          <p className="mt-1">
            <Link href="/editorial-policy" className="text-blue-700 hover:underline no-underline inline-block py-1">Editorial Policy</Link>
          </p>
          <p className="mt-1">
            <Link href="/sources" className="text-blue-700 hover:underline no-underline inline-block py-1">Sources</Link>
          </p>
        </div>
        <div>
