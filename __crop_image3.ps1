...
# Crop: x=730 to exclude text panel, y=100 to y=760 for 4:3-ish landscape
# This captures the plumber + kitchen scene without the graphic text
$cropX = 730
$cropY = 80
$cropW = $img.Width - $cropX    # 806
$cropH = 680                     # landscape-ish

$cropRect = New-Object System.Drawing.Rectangle($cropX, $cropY, $cropW, $cropH)
$cropped = $img.Clone($cropRect, $img.PixelFormat)

# Resize to 780px wide
$targetW = 780
