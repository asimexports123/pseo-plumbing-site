  ...
  return (
    <>
      ...
      <div className="font-sans bg-white min-h-screen flex flex-col">
        ...
        <Breadcrumbs separatorAsListItem items={[{ name: 'Home', url: '/' }, { name: 'Media Kit' }]} />
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            <section>
              ...
              <p className="text-sm text-gray-500 mt-2">
                For downloadable assets or specific logo files, contact <a href="mailto:yohomefix@gmail.com" className="text-blue-600 hover:underline">yohomefix@gmail.com</a>.
              </p>
            </section>
