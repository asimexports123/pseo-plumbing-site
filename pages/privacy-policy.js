  ...
  return (
    <>
      ...
      <div className="font-sans bg-white min-h-screen flex flex-col">
        ...
        <Breadcrumbs separatorAsListItem olClassName="flex items-center gap-1" items={[{ name: 'Home', url: '/' }, { name: 'Privacy Policy' }]} />
          ...
          <div className="space-y-8 text-gray-700 leading-relaxed">
            ...
            <div>
              ...
              <div className="bg-gray-50 p-4 rounded-lg text-sm">
                <p><strong>Phone:</strong> <a href="tel:1" className="text-blue-600">Call Now — 24/7</a></p>
                <p><strong>Email:</strong> yohomefix@gmail.com</p>
              </div>
            </div>
          </div>
