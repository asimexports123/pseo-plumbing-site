...
const inquiryCategories = [
  ...
  },
  {
    ...
    email: 'yohomefix@gmail.com',
    description: 'Editorial questions, corrections, research methodology, and any other general inquiry.',
  },
];
  ...
  return (
    <>
      ...
      <div className="font-sans bg-white min-h-screen flex flex-col">
        ...
        <Breadcrumbs separatorAsListItem items={[{ name: 'Home', url: '/' }, { name: 'Contact' }]} />
