...
const DRAIN_FAQ_POOL = [
  { q: (c,s) => `Do you offer emergency drain service in ${c}?`,
    a: (c,s) => `Yes. Emergency drain service is available 24/7 in ${c}. If you have a severe clog, sewage backup, or multiple drains backing up simultaneously, we dispatch a licensed plumber immediately — day or night. A live dispatcher answers every call, and we aim to have a technician on-site within 60 minutes.` },
