...
function genDrainCleaning(cityName, stateCode, service) {
  ...
  return {
    ...
    sections: [
      {
        heading: h1,
        body: `If you need drain cleaning in ${cityName}, call YoHomeFix and we'll connect you with a licensed local technician who can clear your drains using professional equipment. Our ${cityName} drain cleaning team uses video camera inspection to diagnose the exact cause of blockages before clearing them — ensuring a complete fix rather than a temporary solution. We use hydro-jetting for thorough line clearing and drain snaking for targeted blockage removal. ${trustPhrase}`,
        list: serviceList,
      },
      {
        heading: h2,
...
function genWaterHeater(cityName, stateCode, service) {
  ...
  return {
    ...
    sections: [
      {
        heading: h1,
        body: `If you need water heater repair in ${cityName}, call YoHomeFix and we'll connect you with a licensed local technician who can diagnose and fix your problem. Our ${cityName} water heater technicians service all brands and types — traditional tank units, tankless on-demand systems, heat pump models, and commercial water heaters. We carry the most common replacement parts and units in our service vehicles, allowing most repairs and replacements to be completed in a single visit. ${trustPhrase}`,
        list: serviceList,
      },
      {
        heading: h2,
