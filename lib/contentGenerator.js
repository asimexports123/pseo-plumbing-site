...
function dominantFailureSentence(cityName, d, svc) {
  ...
  const climateDetail = d.winterRisk === 'high'
    ...
    : d.summerRiskNote;
  return `In ${cityName}, the combination of ${tier} water at ${d.hardnessPpm} mg/L from the ${d.waterUtility}, ${d.pipeMaterial} in homes built ${d.pipeEra}, ${d.soilType}, and ${climateDetail} creates conditions where ${d.dominantFailure} is the most commonly diagnosed plumbing failure — a pattern that shapes how our technicians approach every service call in this city.`;
}
