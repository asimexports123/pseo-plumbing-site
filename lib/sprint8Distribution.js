...
export const BACKLINK_TRACKER = [
  {
    platform: 'Zenodo',
    submissionDate: null,
    submissionStatus: 'BLOCKED — requires user to log in to Zenodo with GitHub to enable integration',
    publishedUrl: null,
    backlinkPresent: null,
    backlinkDestination: null,
    linkType: null,
    firstDetectedDate: null,
    notes: 'GitHub release v1.0.0 is published and ready. User must: 1) Go to https://zenodo.org and click "Sign in with GitHub", 2) Go to https://zenodo.org/account/settings/github/, 3) Toggle ON the yohomefix-water-hardness-dataset repo, 4) Click "Sync now". Zenodo will auto-archive the v1.0.0 release and mint a DOI. No manual file upload needed.',
  },
  {
    platform: 'Kaggle',
    submissionDate: null,
